...
To scramble BIDS data you can run the command-line tool named ``scrambler``. At base, this tool has an input and out argument, followed by a ``Data type`` subcommand. The meaning and use of these arguments is explained in more detail in the following sections.
