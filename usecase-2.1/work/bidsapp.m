...
% Here I have chosen to pass the options structure. You could also call the code that
% executes the pipeline differently, depending on how that code was already written.
